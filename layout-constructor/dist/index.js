...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_reducers2.default, {
	    items: {
	        '0': (0, _actions.addContainer)().payload
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var layoutConstructor = (0, _redux.combineReducers)({
	    items: _items2.default
	});

	exports.default = layoutConstructor;
...
/***/ function(module, exports) {
	...
	var leaf = function leaf(state, action) {
	    switch (action.type) {
	        case 'ADD_LEAF':
	...
	var container = function container(state, action) {
	    switch (action.type) {
	        case 'ADD_CONTAINER':
	            return _extends({}, action.payload);
	        default:
	 ...
	 * @param {} childItem
	 */
	var addItemToContent = function addItemToContent(previousState, parentItem, childItem) {
	    var _extends2;

	    parentItem = _extends({}, parentItem, {
	        content: [].concat(_toConsumableArray(parentItem.content), [childItem.id])
	    });

	    return _extends({}, previousState, (_extends2 = {}, _defineProperty(_extends2, childItem.id, childItem), _defineProperty(_extends2, parentItem.id, parentItem), _extends2));
	};
...
/***/ function(module, exports) {
	...
	var addContainer = exports.addContainer = function addContainer(parentId) {
	    return {
	        type: 'ADD_CONTAINER',
	        payload: {
	            id: uniqueId++,
	...
	var addLeaf = exports.addLeaf = function addLeaf(parentId) {
	    return {
	        type: 'ADD_LEAF',
	        payload: {
	            id: uniqueId++,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var ConstructorItem = _react2.default.createClass({
	    displayName: 'ConstructorItem',

	    mixins: [_draggable2.default],

	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { ref: 'draggable', className: 'constructor-item', draggable: 'true' },
	            this.props.children
	        );
	    }
	});
	...
	var App = function App(props) {
	    var content = null;
	    if (props.items[0]) {
	        content = _react2.default.createElement(_container2.default, _extends({}, props.items[0], { items: props.items, key: props.items[0].id }));
	    }
	    return _react2.default.createElement(
	        'div',
	        { className: 'app' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leaf = __webpack_require__(33);
	...
	var Container = _react2.default.createClass({
	    ...
	    propTypes: {
	        ...
	        addContainer: _react2.default.PropTypes.func.isRequired,
	        addLeaf: _react2.default.PropTypes.func.isRequired
	    },
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'div',
	            { ref: 'droppable', className: 'container' },
	            _react2.default.createElement(
	                'h4',
	            ...
	            _react2.default.createElement(
	                ...
	                this.props.content.map(function (childIndex) {
	                    ...
	                    switch (child.type) {
	                        case 'container':
	                            return _react2.default.createElement(Container, _extends({ items: items }, child, { key: child.id }));
	                        case 'leaf':
	                            return _react2.default.createElement(_leaf2.default, _extends({}, child, { key: child.id }));
	                    }
	                })
	            )
	        );
	...
	Container = (0, _reactRedux.connect)(null, { addContainer: _actions.addContainer, addLeaf: _actions.addLeaf })(Container);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leaf = __webpack_require__(34);
